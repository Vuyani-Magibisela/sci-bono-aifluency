...
foreach ($views as $viewName => $viewSQL) {
    try {
        ...
        echo "✗ Error creating $viewName: " . $e->getMessage() . "\n";
        $errorCount++;
    }
}

echo "\n========================================\n";
echo "Views Creation Complete\n";
echo "========================================\n";
echo "Successfully created: $successCount views\n";
echo "Errors: $errorCount\n";
echo "\n";

if ($errorCount === 0) {
    echo "✓ All analytics views created successfully!\n";
}
